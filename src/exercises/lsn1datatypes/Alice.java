...
public class Alice {
    public static void main(String[] args) {
        ...
        System.out.println("The first sentence contains search term " + result);

        Integer index = firstSentence.indexOf(searchTerm);
        Integer length = searchTerm.length();
        System.out.println("your search term appears at index " + index + " your term is "+ length + " character long");
    }
}
